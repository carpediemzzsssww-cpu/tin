...
export function createTin(environment) {
  ...
  const inner=metal.clone();inner.roughness=.42;inner.color.set(0xbcc4c7);
  ...
  return {group,tray,lid,lidPivot,liner,setOpen(amount){lidPivot.rotation.x=THREE.MathUtils.degToRad(-186*amount);}};
}
