...
export function makeTicketSVG(values={}) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="840" height="396" viewBox="0 0 840 396">
    ...
    <g font-family="Arial,Helvetica,sans-serif" fill="#313934"><text x="61" y="82" font-size="17" letter-spacing="5">TIN CINEMA</text><text x="61" y="123" font-size="10" letter-spacing="2">AN ORDINARY NIGHT WORTH KEEPING</text>
    ...
    <text x="61" y="333" font-size="10" letter-spacing="2">KEEP THIS LITTLE MOMENT.</text><text x="729" y="82" font-size="12" text-anchor="middle" letter-spacing="2">ADMIT</text><text x="729" y="156" text-anchor="middle" font-family="Georgia,serif" font-size="60">1</text><text x="729" y="307" text-anchor="middle" font-size="12">NO. 0024</text></g>
